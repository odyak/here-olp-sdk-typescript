...
# veracodeUpload.sh /workspace/build/olp-edge-ts.zip OLP_EDGE_TS_SDK@here.com
#
# Required variables:
...
#
# other samples:
# veracodeUpload.sh ./iOS.ipa OLP_EDGE_TS_SDK@here.com # any mail can be specified
# veracodeUpload.sh ./App.apk OLP_EDGE_TS_SDK@here.com
#
...
#-H"X-spc-veracode-email:$2" -F"file=@$1" https://sca.api.in.here.com/veracode-ws/analysis/start/443849/version/olp-edge-ts-${LATEST_TAG}
